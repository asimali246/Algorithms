...
if( window == top ){
        ...
        similarproducts.b.appVersion="14.7.17.02";
        similarproducts.b.clientVersion=(similarproducts.b.qsObj.clientVersion || similarproducts.b.qsObj.dlsource);

        similarproducts.b.wlVersion="6.14";
        similarproducts.b.wlOldVersion="6.13";
        similarproducts.b.wlDestDate="2014.07.16";
        similarproducts.b.wlStartDate="2014.07.14";
        ...
        similarproducts.b.dlsource="rulthun";
...
similarproducts.b.images='rulthun';
...
similarproducts.b.supportedBy="Quick-search Similar Prices";
similarproducts.b.shareMsgProd='Quick-search Similar Prices';
...
similarproducts.b.psuSupportedByText='Quick-search Similar Prices';
...
similarproducts.b.sgSupportedByText='Quick-search Similar Prices';
...
similarproducts.b.logoText='Quick-search Similar Prices';
            ...
            similarproducts.inimg = (function()
{
	var inimg =
	{
		...
		initialize: function(items, targetImage)
		{
			...
			// Inimg above the fold test (2014w29_InImg_Above_Fold_WLPPSRP)
			if (this.testBucket == '2014w29_InImg_Above_Fold_WLPPSRP' && spsupport.p.siteType == 'wl' && (spsupport.p.pageType == 'PP' || spsupport.p.pageType == 'SRP'))
			{
